...
public enum Keywords
{
    ...
    /// <summary>
    /// Aspect: Fire. Draft: Whenever another Fire card is played
    /// </summary>
    HotStreak = 1 << 15,

    /// <summary>
    /// Aspect: Lightning. Draft: Merge with another Lightning unit
    /// </summary>
    Static = 1 << 16,

    /// <summary>
    /// Aspect: Earth. Combat: When X friendly Earth unit(s) dies
    /// </summary>
    Aftershock = 1 << 17,
